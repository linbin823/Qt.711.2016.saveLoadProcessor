...
#include "../../../src/common/basedevice.h"
...
void *baseDevice::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "siErrMsg"))
        return static_cast< siErrMsg*>(const_cast< baseDevice*>(this));
    if (!strcmp(_clname, "siStateMsg"))
        return static_cast< siStateMsg*>(const_cast< baseDevice*>(this));
    if (!strcmp(_clname, "siLoadSave"))
        return static_cast< siLoadSave*>(const_cast< baseDevice*>(this));
