...
#include "../../../src/loadSave/loadsaveprocessorxml.h"
...
void loadSaveProcessorXml::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&loadSaveProcessorXml::resXmlRefresh)) {
                *result = 0;
            }
        }
        {
            typedef void (loadSaveProcessorXml::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&loadSaveProcessorXml::resXmlFilePathChanged)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject loadSaveProcessorXml::staticMetaObject = {
    { &baseDevice::staticMetaObject, qt_meta_stringdata_loadSaveProcessorXml.data,
      qt_meta_data_loadSaveProcessorXml,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *loadSaveProcessorXml::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_loadSaveProcessorXml.stringdata0))
        return static_cast<void*>(const_cast< loadSaveProcessorXml*>(this));
    if (!strcmp(_clname, "siLoadSaveProcessor"))
        return static_cast< siLoadSaveProcessor*>(const_cast< loadSaveProcessorXml*>(this));
